package com.shailesh.ecl;

import com.shailesh.blc.Appointment;
import com.shailesh.blc.Doctor;
import com.shailesh.blc.Patient;
        ...
        do {
            ...
            switch (choice) {
                ...
                case 0:
                    ...
                    break;
                default:
                    System.out.println("Invalid choic1e. Please try again.");
            }
        } while (choice != 0);
